...
public class AddProduct extends Activity  {
    ...
    numarbucati.addTextChangedListener(new TextWatcher() {
    ...
    private String addNumbers() {
        double number1; 
        double number2;
        if(priceView.getText().toString() != "" && priceView.getText().length() > 0) {
            number1 = Double.parseDouble(priceView.getText().toString());
        } else {
            number1 = 0;
        }
        if(numarbucati.getText().toString() != "" && numarbucati.getText().length() > 0) {
            number2 = Double.parseDouble(numarbucati.getText().toString());
        } else {
            number2 = 0;
        }
