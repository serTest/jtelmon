    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            for(int i=0;i<nameArray.length();i++)
            {
                ...
                Log.i("_GetProducts_","<Agent"+i+">"      + tempStringAgent      +"</Agent"    +i+">\n");
                Log.i("_GetProducts_","<Client"+i+">"    + tempStringClient    +"</Client"    +i+">\n");
                Log.i("_GetProducts_","<Route"+i+">"   + tempStringRoute   +"</Route"   +i+">\n");
                Log.i("_GetProducts_","<Zone"+i+">"  + tempStringZone  +"</Zone"+i+">\n");
