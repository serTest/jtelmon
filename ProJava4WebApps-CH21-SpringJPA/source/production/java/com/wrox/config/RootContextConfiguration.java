 ...
 *  https://github.com/Serge009/Professional-Java-for-Web-Applications.git
 ...
 * MySQL 4.x  Generic       : org.hibernate.dialect.MySQLDialect
        ...
        AsyncConfigurer, SchedulingConfigurer
{
    ...
    /*
     * Creates a simple DataSource that returns single-use Connections. Because it does
	 * not provide connection pooling, it really should never be used in a production environment of any type.      
    @Bean
