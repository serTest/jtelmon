...
{
	private static final String SOAP_ACTION = "wsUsers";
	private static final String NAMESPACE   = "wsUsers";
	private static final String URL         = "http://localhost/TestWeb/MiniPassport2.asmx";
