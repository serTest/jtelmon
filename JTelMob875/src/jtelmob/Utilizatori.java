...
public class Utilizatori implements Serializable {
    ...
    @JoinColumn(name = "localitate", referencedColumnName = "city_name")
    @ManyToOne
    private Ncities localitate;
    ...
    public Ncities getLocalitate() {
        return localitate;
    }

    public void setLocalitate(Ncities localitate) {
        Ncities oldLocalitate = this.localitate;
